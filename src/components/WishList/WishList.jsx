    ...
    <>
      <div className="row container mx-auto">
        {wishListDetails?.map((product) => (
          <>
            <div className="lg:w-1/6 px-4 md:w-1/3 sm:w-full">
              <div className="product py-4 rounded-xl bg-white p-3 shadow-md hover:shadow-xl hover:transform hover:scale-105 duration-500 hover:border-green-600 border-2 mt-2">
                <img
